...
public class SiliconValley {
	public static void main(String[] args) {
		...
		//обьекты класса офис так же создаются в классе офис? но, если мне нужно протестировать корректность выполнения метода отбора секретарей в
		//main, тогла офисы нужно создавать в классе siliconValley, поскольку класс офис является нестатическим и никакие переменные из него без создания
