...
/*Написать имплементацию интерфейса List*/
...
public class MyArrayList<T> implements List<T> {
    ...
    private class SubList extends MyArrayList<T> implements RandomAccess {
        private final MyArrayList<T> parent;
        private final int parentOffset;
        private final int offset;
        int size;

        SubList(MyArrayList<T> parent,
        ...
        public T set(int index, T e) {
            rangeCheck(index);
            checkForComodification();
            T oldValue = MyArrayList.this.elementData(offset + index);
        ...
        public Spliterator<T> spliterator() {
            checkForComodification();
            return new ArrayListSpliterator<T>(MyArrayList.this, offset,
                    offset + this.size, this.modCount);
        }
    }

    static final class ArrayListSpliterator<T> implements Spliterator<T> {
        ...
        ArrayListSpliterator(MyArrayList<T> list, int origin, int fence,
        ...
        public boolean tryAdvance(Consumer<? super T> action) {
            ...
            if (i < hi) {
                index = i + 1;
                @SuppressWarnings("unchecked") T e = (T)list.elementData[i];
                action.accept(e);
        ...
        public void forEachRemaining(Consumer<? super T> action) {
            ...
            if ((lst = list) != null && (a = lst.elementData) != null) {
                ...
                if ((i = index) >= 0 && (index = hi) <= a.length) {
                    for (; i < hi; ++i) {
                        @SuppressWarnings("unchecked") T e = (T) a[i];
                        action.accept(e);
                    }
                    if (lst.modCount == mc)
                        return;
