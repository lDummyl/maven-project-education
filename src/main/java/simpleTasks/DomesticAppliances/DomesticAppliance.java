...
public abstract class DomesticAppliance { // TODO: 4/4/20 газовая плита тоже бытовая техника
    ...
    public abstract ElectricityCost consumeElectricity(); // TODO: 4/4/20 вещи сами не платят за электричество, они могут его потреблять, сообщать потребленное кол-во
