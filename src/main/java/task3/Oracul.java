...
public class Oracul {
    ...
    // TODO: 5/15/20 оракул не должен быть статическим он может менять ключевые аспекты поведения в зависимости от того
    //  какими полями инициализирован его инстанс
    ...
    public void longAnswer() {
        // TODO: 5/19/20 это не то что я имел в виду, это будет легко понять когда примешься за тестирование.
        //  Но я бы начал с задачи 1 и 2 упражняться в написании unit тестов
