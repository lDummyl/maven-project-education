...
public class Main {
	public static void main(String[] args) {
		...
		// TODO: 10/25/19 не все фаилы следует коммитить в репозиторий. Есть исключения например папка .idea
		//  чтобы она не подтягивалась есть фаил gitignore в него следует добавлять такие вещи.

		// TODO: 10/25/19 лично я не возражаю насчет параллельного выполнения задач. Но есть океан статей, которые пытаются доказать что
		//  параллелизма следует избегать в разработке изо всех сил.
