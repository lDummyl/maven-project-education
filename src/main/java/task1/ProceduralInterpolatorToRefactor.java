...
public abstract class ProceduralInterpolatorToRefactor implements Interpolator {
...
// Polynomial Lagrange interpolation
    ...
    public static void main(String[] args) {
        ...
        float[] arrayx = new float[2]; //Array limit 199
        float[] arrayy = new float[2]; //Array limit 199
