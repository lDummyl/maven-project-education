...
public class SeekerTest {
    ...
    public void seekerTest() {
        ...
        Oracle oracle = new Oracle(3, Duration.ofMillis(3L)); // TODO: 9/1/19  чтобы не ждать 100 лет пока тест пройдет, а так быть не должно в принципе, при инициализации я бы передавал в констуктор максимальное время ожидания оракула(именно время(Duration) никаких интов) и тогда в тестовом режиме все бы проходило за разумный период
